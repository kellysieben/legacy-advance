using System.Web;
using Legacy.EventLog.Infrastructure;
using Microsoft.Practices.Unity;
using Unity.WebForms;

[assembly: WebActivatorEx.PostApplicationStartMethod( typeof(Legacy.EventLog.App_Start.UnityWebFormsStart), "PostStart" )]
namespace Legacy.EventLog.App_Start
{
	/// <summary>
